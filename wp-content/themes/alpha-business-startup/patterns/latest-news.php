<?php
 /**
  * Title: Latest News
  * Slug: alpha-business-startup/latest-news
  * Categories: alpha-business-startup
  */
?>

<!-- wp:group {"style":{"spacing":{"padding":{"top":"80px","right":"0px","bottom":"80px","left":"0px"},"blockGap":"0px"}},"layout":{"inherit":true,"type":"constrained","contentSize":"80%"}} -->
...
<p class="has-text-align-left has-primary-color has-text-color has-medium-font-size" style="letter-spacing:1px"><?php esc_html_e('From Our Blog','alpha-business-startup'); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:heading {"textAlign":"left","className":" animated animated-fadeInUp","style":{"typography":{"lineHeight":"1.3"}},"fontSize":"slider-title"} -->
<h2 class="wp-block-heading has-text-align-left animated animated-fadeInUp has-slider-title-font-size" style="line-height:1.3"><?php esc_html_e('Recent News','alpha-business-startup'); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<div class="wp-block-buttons animated animated-fadeInUp" style="margin-top:20px;margin-bottom:20px"><!-- wp:button {"className":"is-style-fill","style":{"spacing":{"padding":{"right":"35px","left":"35px"}},"border":{"radius":"5px"}}} -->
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link wp-element-button" href="#" style="border-radius:5px;padding-right:35px;padding-left:35px"><?php esc_html_e('Explore More','alpha-business-startup'); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
